...
<template>
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        >
            <div
                class="flex items-center justify-between border-b border-border bg-muted px-4 py-3"
            >
