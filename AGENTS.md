...
- [ ] Create migrations: roles, post_statuses, vote_types, posts, tags, post_tag, comments, votes
- [ ] Update users table with role_id foreign key
- [ ] Create models: Role, PostStatus, VoteType, Post, Tag, Comment, Vote
- [ ] Add relationships to User model
- [ ] Create database seeders for roles and default data
